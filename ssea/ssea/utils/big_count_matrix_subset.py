...
def main():
    ...
    parser.add_argument('--samples', dest="sample_ids", default=None)
    ...
    # get sample and transcript ids
    if args.sample_ids is not None:
        sample_ids = set([line.strip() for line in open(args.sample_ids)])
    else:
        sample_ids = set()
    ...
    bm.copy(args.output_dir, transcript_ids, sample_ids)
    bm.close()
